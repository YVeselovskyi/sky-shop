...
import { FormControl, InputLabel, Select, MenuItem, Grid, Paper, InputBase, IconButton, Button, Typography } from '@material-ui/core';
...
function sort({ setSort, sortBy, searchQuery, setSearchQuery, totalPrice, count }) {
    ...
    return (
        <>
            ...
            <Grid item xs={12} sm={4} md={3}>
                ...
                >
                    <Typography variant='body2' align='left' className={classes.cartPrice}>
                        Total: {totalPrice}$
                    </Typography>
